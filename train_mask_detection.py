...
directory=r"D:\Tensorflow Projects\Face Mask Detection(OpenCV, TF, Mobilenet)\dataset"
...
(train_X, test_X, train_Y, test_Y)=train_test_split(data, labels, test_size=0.20, stratify=labels, random_state=24)
